...
public class StudentRegistration extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean resultOfAddCustomer =databaseObject.addCustomer(studentName, gender, mobileNumber, college, department, email, address, city, state, country, studentUsername, lastName, role);
