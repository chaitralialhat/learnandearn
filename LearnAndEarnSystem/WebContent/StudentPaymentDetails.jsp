...
<div style="position:absolute; top:80px; left:550px;">
<form method="get" action="http://localhost:8086/LearnAndEarnSystem/StudentPaymentDetails.jsp">

<lable><b>Student Name </b></lable><input type="text" name="firstname" placeholder="first name" required>
...
<input type="submit" name="submit" style="position:relative; left:150px;" class="button"><br>
</div>
...
<table align="center" border="1">
		...
		<% 
			...
			try {
				...
				String sql = ("SELECT *from workingtime where username='"+username+"' and date BETWEEN '"+from+"' and '"+to+"'" );
